...
public class LoopsAndModel {
    public static void main(String[] args) {
        ...
        java.addStudent(new Student("Natalja", "NoName", "Ņatali@mail.ru"));
      ...
      //  System.out.println(java.getStudents().get(1).getFirstName());
        ...
        for (Student s : students) {
            ...
            if (s.getFirstName().startsWith("N")) {
                ...
                //false
                System.out.println("This name is not starts with 'N'");
            }


            System.out.println(s.getFirstName().startsWith("N") ? s.getFullName() : "This name is not starts with 'N'");
